...
<div id="container">
    <header id="header"> 
        <nav id="nav">
        <ul>
            <li><a id="button_home" href="#" class="awesome icon"><img
                src="images/gnome_home.png" class="icon" alt="Home" title="Home" /></a></li>
            <li><a id="button_new" href="#" class="awesome icon"><img
                src="images/gnome_new.png" class="icon" alt="New" title="New" /></a></li>
            <li><a id="button_saved" href="#" class="awesome icon"><img
                src="images/gnome_open.png" class="icon"
                style="z-index: 1; position: relative;" alt="Saved"
                title="Saved" /><span id="num_saved"
                style="position: absolute; z-index: 2; right: .2em; bottom: .1em;"></span></a></li>
            <li><a id="button_config" href="#" class="awesome icon"><img
                src="images/gnome_system.png" class="icon" alt="Config"
                title="Config" /></a></li>
        </ul>
        </nav>
...
<div id="saved_docs">No saved documents.</div>
